...
# Prompt
template = """Use the context and the problem to answer the question.
...
question = "The code in the context is supposed to answer the problem, but there is a bug. Find and explain why there is a bug. Then, propose a slightly modified code that solves this issue."
